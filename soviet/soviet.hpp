...
public:
  ...
  static void joincoop_effect(eosio::name executer, eosio::name coopname, uint64_t decision_id, uint64_t secondary_id);
  ...
  //chairman.cpp
  [[eosio::action]] void authorize(eosio::name coopname, eosio::name chairman, uint64_t decision_id);
  ...
  //marketplace.cpp
  [[eosio::action]] void change(eosio::name coopname, uint64_t program_id, uint64_t exchange_id);

  static void change_effect(eosio::name executer, eosio::name coopname, uint64_t decision_id, uint64_t secondary_id);
  ...
  [[eosio::action]] void contribute(eosio::name coopname, eosio::name username, uint64_t program_id, eosio::asset quantity, eosio::name type, uint64_t secondary_id);
