...
public:
  using contract::contract;
   //sovet.cpp
  [[eosio::action]] void exec(eosio::name executer, uint64_t document_id);
  [[eosio::action]] void newid(uint64_t document_id);

  //admin.cpp
  [[eosio::action]] void addadmin(uint64_t board_id, eosio::name chairman, eosio::name username, std::vector<eosio::name> rights, std::string meta);
  [[eosio::action]] void rmadmin(uint64_t board_id, eosio::name chairman, eosio::name username);
  [[eosio::action]] void setadmrights(uint64_t board_id, eosio::name chairman, eosio::name username, std::vector<eosio::name> rights);
  [[eosio::action]] void validate(uint64_t board_id, eosio::name username, uint64_t document_id);
  
  //regaccount.cpp
  [[eosio::action]] void regaccount(eosio::name username);
  
  static void regaccount_effect(eosio::name executer, uint64_t document_id, eosio::name username);
  ...
  //chairman.cpp
  [[eosio::action]] void authorize(eosio::name chairman, uint64_t document_id);
  [[eosio::action]] void createboard(uint64_t coop_id, uint64_t parent_id, eosio::name chairman, std::vector<eosio::name> members);
  ...
  //voting.cpp
  [[eosio::action]] void votefor(eosio::name member, uint64_t document_id);
  [[eosio::action]] void voteagainst(eosio::name member, uint64_t document_id);
  [[eosio::action]] void cancelvote(eosio::name member, uint64_t document_id);

  //marketplace.cpp
  [[eosio::action]] void change(uint64_t order_id);
  static void change_effect(eosio::name executer, uint64_t document_id, eosio::name username);
